        ...
        event: {
          field: {
            ...
            blur: function blur(event) {
              ...
              } else if (_settings2.on == 'blur' || _settings2.on == 'change') {
                if (validationRules) {
                  module.validate.field(validationRules);
                }
              }
        ...
        get: {
          ...
          prompt: function prompt(rule, field) {
            var ruleName = module.get.ruleName(rule),
                ...
                prompt = rule.prompt || _settings2.prompt[ruleName] || _settings2.text.unspecifiedRule,
      ...
      module = {
        ...
        set: {
          ...
          value: function value(_value2, text, $selected) {
            var escapedValue = module.escape.value(_value2),
                ...
                isAddition = !module.has.value(_value2),
        ...
        has: {
          ...
          value: function value(_value3) {
            var values = module.get.values(),
                hasValue = $.isArray(values) ? values && $.inArray(_value3, values) !== -1 : values == _value3;
